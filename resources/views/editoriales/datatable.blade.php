    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                 {!! Form::open(['url' => 'editorialesDestroy']) !!}
                 <span id="escribir">
                
                </span>
               
                <button type="submit" id="eliminarEditorial" name="eliminarEditorial" class="btn btn-delete btn-danger" onClick="dte()">Eliminar</button>
